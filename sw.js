const CACHE = 'dungeon-survivor-v0.2.5fff';
...
const PRECACHE = [
  ...
  // Current modular walls plus compatibility fallbacks.
  ...
  './top-wall-clean.png', './top-wall-cracked.png', './top-wall-mossy.png',
  './left-wall-clean.png', './right-wall-clean.png', './bottom-wall-clean.png'
];
